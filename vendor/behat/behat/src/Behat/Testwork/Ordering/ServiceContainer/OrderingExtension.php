...
final class OrderingExtension implements Extension
{
    ...
    private function loadDefaultOrderers(ContainerBuilder $container)
    {
        ...
        $definition = new Definition('Behat\Testwork\Ordering\Orderer\DoubleRandomOrderer');
        $definition->addTag(self::ORDERER_TAG, array('priority' => -9999));
        $container->setDefinition(TesterExtension::EXERCISE_WRAPPER_TAG . '.ordering.double-random', $definition);
    }
}
